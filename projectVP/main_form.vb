...
Public Class main_form
    ...
    Public Sub add_btn_Click(sender As Object, e As EventArgs) Handles add_btn.Click
        ...
        obj.DbOpreation("insert into employee ( employee_name,employee_ssn,employee_dob,employee_dp) values('" & name_txt.Text & "','" & ssn & "','" & dob_txt.Text & "','" & dp_txt.Text & "')")
    ...
    Private Sub edit_btn_Click(sender As Object, e As EventArgs) Handles edit_btn.Click
        ...
        If ssn.Length <> 12 Then
            ...
            Return
        End If
        obj.DbOpreation("UPDATE employee SET employee_name = '" & name_txt.Text & "', employee_ssn = '" & emp_ssn.Text & "', employee_dob = '" & dob_txt.Text & "', employee_dp = '" & dp_txt.Text & "'  WHERE id = " & id_txt.Text)
        obj.displayOnDataGrid("select * from employee  ", emp_data_grid_view)
    End Sub
